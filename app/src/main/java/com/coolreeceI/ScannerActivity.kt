...
import com.coolreeceI.databinding.ActivityScannerBinding
...
//                            Log.i("BarcodeResults", "${it.displayValue}")
//
//                        }
//                    }
//
...
//    }
    ...
    private fun beginCamara() {
        Log.i(TAG, "beginCamera")
        var cameraController = LifecycleCameraController(baseContext)
        ...
        cameraController.setImageAnalysisAnalyzer(
            ...
            MlKitAnalyzer(
                ...
                if ((barcodeResults == null) ||
                    ...
                    Log.i(TAG, "bar code results null")
